    ...
    public function run(): void
    {
        ...
        $docFields = [
            [
                ...
                'field_type' => 'file',
                'is_required' => true,
                'file_config' => ['accepted_types' => ['pdf', 'jpg', 'jpeg', 'png'], 'max_size_mb' => 100],
            ],
            [
                ...
                'field_type' => 'file',
                'is_required' => true,
                'file_config' => ['accepted_types' => ['pdf', 'jpg', 'jpeg', 'png', 'doc', 'docx'], 'max_size_mb' => 100],
            ],
            [
                ...
                'field_type' => 'file',
                'is_required' => false,
                'file_config' => ['accepted_types' => ['pdf', 'doc', 'docx'], 'max_size_mb' => 100],
            ],
        ];
